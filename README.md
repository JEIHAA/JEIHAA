<div align= "center">
    <img src="https://capsule-render.vercel.app/api?type=waving&color=384c39&height=120&text=Dillge,%20et%20quod%20vis%20fac&animation=&fontColor=d6d6d6&fontSize=40" />
    </div>
    <div style="text-align: left;"> 
    <h2 style="border-bottom: 1px solid #21262d; color: #c9d1d9;"> 이희언입니다. </h2>  
    <div style="font-weight: 700; font-size: 15px; text-align: left; color: #c9d1d9;"> 세상이 동작하는 방식을 탐구하고<br>더 깊은 지식을 추구하는 </div> 
    </div>
    <div style="text-align: left;">
